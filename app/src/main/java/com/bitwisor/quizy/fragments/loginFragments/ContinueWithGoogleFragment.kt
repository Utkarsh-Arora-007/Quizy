package com.bitwisor.quizy.fragments.loginFragments
...
import com.bitwisor.quizy.databinding.FragmentContinueWithGoogleBinding
...
class ContinueWithGoogleFragment : Fragment() {
    ...
    private fun createRequest() {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken(getString(com.bitwisor.quizy.R.string.default_web_client_id))
            .requestEmail()
            .build()
